      ...
      <div className="section__container space-y-16 p-10 font-sans mb-[80px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          <div className="space-y-6">
            ...
            <Image src="/home/homepage_1.png" alt="Room" width={500} height={226} className="rounded-xl object-cover w-full" style={{ height: "226px" }} />
          ...
          {/* Col 2: Large Image */}
          <div>
            <Image src="/home/homepage_1.png" alt="Chair Large" width={600} height={524} className="rounded-xl object-cover w-full" style={{ height: "524px" }} />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="flex gap-4">
            <Image src="/home/homepage_1.png" alt="Stone Chair" width={200} height={300} className="rounded-lg" />
            <Image src="/home/homepage_1.png" alt="Wave Chair" width={200} height={300} className="rounded-lg" />
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Image src="/home/homepage_1.png" alt="Chair 1" width={200} height={300} className="rounded-lg" />
            <Image src="/home/homepage_1.png" alt="Chair 2" width={200} height={300} className="rounded-lg" />
            <Image src="/home/homepage_1.png" alt="Chair 3" width={200} height={300} className="rounded-lg" />
            <Image src="/home/homepage_1.png" alt="Chair 4" width={200} height={300} className="rounded-lg" />
          </div>
        </div>

        {/* Section 5: Ghế trung tâm với chữ 2 bên */}
        <div className="relative text-center">
          <Image src="/home/homepage_1.png" alt="Center Chair" width={400} height={400} className="mx-auto" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex gap-4">
            <Image src="/home/homepage_1.png" alt="Side Chair 1" width={200} height={300} className="rounded-lg" />
            <Image src="/home/homepage_1.png" alt="Side Chair 2" width={200} height={300} className="rounded-lg" />
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="col-span-2 grid grid-cols-2 gap-4">
              <Image src="/home/homepage_1.png" alt="Article 1" width={300} height={200} className="rounded-lg" />
              <Image src="/home/homepage_1.png" alt="Article 2" width={300} height={200} className="rounded-lg" />
            </div>
          </div>
        </div>
      </div>
