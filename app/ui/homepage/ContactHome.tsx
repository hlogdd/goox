  ...
  return (
    <div className="section__container flex flex-col md:flex-row gap-12 py-12">
      ...
      <div className="flex-1">
        <h2 className="text-[40px] sm:text-[48px] md:text-[56px] font-medium mb-6 uppercase max-w-[400px] leading-[1.1]">
          Let&apos;s work together
        </h2>
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <button
            type="submit"
            className="text-white py-3 px-6 hover:bg-gray-800 transition md:col-span-2 bg-primary !font-bold"
          >
            Gửi liên hệ
          </button>
        </form>
      ...
      <div className="flex-1 flex justify-center md:justify-end">
        <div className="max-w-[500px] w-full h-[400px] md:h-full relative overflow-hidden shadow-lg">
